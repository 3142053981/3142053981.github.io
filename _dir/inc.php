...
if(!$conf){
	if(!$CACHE->set('config', ['admin_username'=>'admin','admin_password'=>md5('123456'),'title'=>'目录列表', 'keywords'=>'目录列表,Directory Lister目录列表,目录索引','description'=>'目录列表程序','announce'=>'','footer'=>'', 'name_encode'=>'utf8', 'file_hash'=>'1', 'cache_indexes'=>'0', 'footer_bar'=>'1', 'readme_md'=>'1', 'auth'=>'0', 'nav'=>'说明*http://ddvnm.ct8.pl/?thread-31.htm|'])){
